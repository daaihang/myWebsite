+++
title = 'JavaScript 开发者应懂的 33 个概念*'
date = 2024-04-16T10:04:49+08:00
+++

本文转载自 [每位 JS 开发应该懂的 33 个概念（中文版）](https://github.com/stephentian/33-js-concepts)，其英文原版为 [leonardomso/33-js-concepts](https://github.com/leonardomso/33-js-concepts)。
